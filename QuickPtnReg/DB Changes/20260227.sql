...
USE [SOFCWHMIS_MUM]
GO
/****** Object:  StoredProcedure [dbo].[SpInsPtnQuickRegSelf]    Script Date: 27-02-2026 10:49:54 ******/
SET ANSI_NULLS ON
GO
...
@PatientAddressLine3 varchar(150),    
@DocUnitCd int    =0,
@PatientMrtlStsCd   INT =2,
@ptn_lst_nm          VARCHAR(100) = '',                   
@ptn_frst_nm         VARCHAR(100) = '',                   
@ptn_mid_nm          VARCHAR(100) = '' 
)        
as        
/*        
Author : Sachin Manugade        
...
begin         
 ...
 @typ_flg=N'P',        
 @ttl_cd=1,        
 @ptn_lst_nm=@ptn_lst_nm ,        
 @ptn_frst_nm=@ptn_frst_nm ,
 @ptn_mid_nm=@ptn_mid_nm,        
 @sex=@Sex,        
 @brth_dt= @dateofBirth  ,        
 @age_yy=@Age,        
 @age_mm=0,        
