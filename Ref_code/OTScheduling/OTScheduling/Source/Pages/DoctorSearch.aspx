<%@ Page Language="VB" AutoEventWireup="false" Inherits="OTScheduling.Pages_DoctorSearch" Codebehind="DoctorSearch.aspx.vb" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=GrdDoctorDetails.ClientID%> tr:has(td)").click(function (e) {
                ...
                //ReturnValues(MyArgs, document.getElementById("str"), document.getElementById("cntrl"),  document.getElementById("cntrl").value);
