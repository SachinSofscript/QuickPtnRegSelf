...
#End Region
    ...
    Public Sub GetOTDtlsByFilter()
        ...
        Dim ArCD As String = ""
        ArCD = IIf(txtCreditCoCd.Text <> "", txtCreditCoCd.Text, "")

        Dim FctCd As Integer = 0

        If txtOT.Text <> "" Then
            FctCd = Convert.ToInt32(txtOT.Text)
        End If



        Dim PtnTypeCd As Integer = 0

        If ddlPtnTypByUser.SelectedValue.Trim <> "ALL" Then
            PtnTypeCd = Convert.ToInt32(ddlPtnTypByUser.SelectedValue)
        End If

        Dim ChkDtFlg As Boolean = 1
        ...
        obj = OTScheduling.GetDtlsByFilter(strErrMsg, chrErrFlg, Session("COMPANYCODE"), Session("DIVCODE"), Session("LOCCODE"), CDate(txtFrmDate.Text).ToString("dd/MM/yyyy"), CDate(txtToDate.Text).ToString("dd/MM/yyyy"), IIf(RBSurgary.Checked, "1", "2"), APTM_STS, ArCD, FctCd, PtnTypeCd, ChkDtFlg)
        ...
        If obj IsNot Nothing Then
            ...
            If obj.Count > 0 Then
                ...
                'clsGeneral.ShowErrorPopUp("count=" + obj.Count.ToString, "", Page)
            ...
            Else
                ...
                clsGeneral.ShowErrorPopUp("No Record Found", "", Page)

                grdOTList.DataSource = New List(Of String)
                grdOTList.DataBind()
    ...
    Public Sub ClearAll()
        ...
        txtOT.Text = ""
        txtOTDesc.Text = ""
        RBBooking.Checked = False
        RBSurgary.Checked = True
        rdbActive.Checked = False
        rdbCancelled.Checked = False
        'rdbAll.Checked = True comment by shivkumar 15/11/2021
        rdbActive.Checked = True 'added by  shivkumar 15/11/2021
    ...
    Protected Sub grdOTList_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        Try
            ...
            If (e.Row.RowType = DataControlRowType.DataRow) Then
                ...
                e.Row.Attributes("onclick") = ClientScript.GetPostBackClientHyperlink(Me.grdOTList, "Select$" & e.Row.RowIndex)
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs)
        GetOTDtlsByFilter()
        '  ScriptManager.RegisterClientScriptBlock(Page, Me.GetType(), Guid.NewGuid().ToString(), "ResizeCol();", True)
